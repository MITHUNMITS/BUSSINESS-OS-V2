...
| Facility adaptation | Facility type was modeled, but terminology packs, default modules, forms, workflows, reports, and website sections were not planned enough. | Business OS becomes ecommerce-biased instead of facility-aware. | Facility terminology resolver, Business Admin label wiring, and the basic offering/category/collection form lifecycles are implemented; finish remaining facility-aware forms, module defaults, workflows, reports, and website sections. | Foundation |
...
| Forms and controls | Master spec lists many production forms, but planning only covered broad form behavior. | Missing admin workflows during build. | The basic catalogue offering, category, and collection create/edit/lifecycle forms now have schema, tenant/facility validation, audit, and tests; each remaining form must receive the same treatment before it is marked complete. | Foundation |
...
- 2026-07-12: Catalogue category admin lifecycle scope implemented with list/create/detail/edit/archive/restore routes, facility-aware category schema, slug and parent validation, POST-only lifecycle actions, create/update/archive/restore audit events, and category assignment from offering create/edit. Catalogue remains foundation because collections, media, variants, imports/exports, filtering, pagination, and bulk actions are separate future slices.
- 2026-07-12: Catalogue collection admin lifecycle scope implemented with list/create/detail/edit/archive/restore routes, facility-aware membership labels, slug validation, POST-only lifecycle actions, offering membership synchronization, create/update/archive/restore audit events, and collection membership display on offering detail. Catalogue remains foundation because media, variants, imports/exports, public collection pages, filtering, pagination, drag/drop ordering, and bulk actions are separate future slices.
