...
| Facility adaptation | Facility type was modeled, but terminology packs, default modules, forms, workflows, reports, and website sections were not planned enough. | Business OS becomes ecommerce-biased instead of facility-aware. | Facility terminology resolver, Business Admin label wiring, and the first facility-aware offering create form are implemented; finish remaining facility-aware forms, module defaults, workflows, reports, and website sections. | Foundation |
